...
export CORE_PEER_LISTENADDRESS=${PEER}.${ORG}.example.com:7051
export CORE_PEER_CHAINCODEADDRESS=${IP_ADDRESS}:7052
export CORE_PEER_CHAINCODELISTENADDRESS=${IP_ADDRESS}:7052
export CORE_PEER_GOSSIP_BOOTSTRAP=peer0.${ORG}.example.com:7051
export CORE_PEER_GOSSIP_EXTERNALENDPOINT=${PEER}.${ORG}.example.com:7051
