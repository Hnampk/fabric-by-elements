...
// 		if targetOrg == "org2" && targetPeer == "peer3" {
// 			proposer, err = initProposer(i, []string{peerAddress, "peer1.org3.example.com:7051"}, peerMSPID, org, channel, tlsRootCertFile, clientKeyFile, clientCertFile)
// 		} else {
// 			proposer, err = initProposer(i, []string{peerAddress}, peerMSPID, org, channel, tlsRootCertFile, clientKeyFile, clientCertFile)
// 		}
...
// 	var signerConfig2 = signerLib.Config{
// 		MSPID:        p.peerMSPID,
// 		IdentityPath: rootURL + "peers/crypto-config/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp/signcerts/Admin@org3.example.com-cert.pem",
// 		KeyPath:      rootURL + "peers/crypto-config/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp/keystore/priv_sk",
// 	}

// 	signer2, err := signerLib.NewSigner(signerConfig2)

// 	signedProp2, err := protoutil.GetSignedProposal(prop, signer2)
// 	if err != nil {
// 		// fmt.Println("[ERROR] propose: GetSignedProposal:", err)
// 		return nil, err
// 	}
